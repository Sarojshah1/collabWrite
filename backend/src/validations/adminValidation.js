...
export const validateListUsers = [...validatePagination];
...
export const validateDeleteUser = [param("id").isMongoId()];

export const validateUpdateUserRole = [
  param("id").isMongoId(),
  body("role").isIn(["user", "admin", "editor", "moderator"]),
];
...
export const validateApproveBlog = [param("id").isMongoId()];
