...
export const validateGetBlog = [param("id").isMongoId()];

export const validateToggleLike = [param("id").isMongoId()];

export const validateToggleBookmark = [param("id").isMongoId()];
...
export const validateListVersions = [param("id").isMongoId()];
