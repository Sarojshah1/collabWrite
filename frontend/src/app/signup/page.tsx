          ...
          <div className="mb-8">
            <div className="flex justify-center">
              <div className="flex items-center gap-2 text-sm font-semibold text-zinc-900">
                <span className="inline-flex h-6 w-6 items-center justify-center rounded-[0.5rem] border border-zinc-200 text-xs">
                  CW
                </span>
            ...
            <form onSubmit={onSubmit} className="space-y-4" noValidate>
              <div>
                ...
                <input
                  ...
                  className={`mt-1 w-full rounded-md border px-3 py-2 text-sm text-black placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900 ${
                    fieldErrors.name ? "border-red-400" : "border-zinc-300"
                  }`}
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <input
                    ...
                    className={`w-full rounded-md border px-3 py-2 pr-10 text-sm text-black placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900 ${
