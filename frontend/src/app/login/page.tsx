            ...
            <form onSubmit={onSubmit} className="space-y-4" noValidate>
              <div>
                ...
                <input
                  ...
                  className={`mt-1 w-full rounded-md border px-3 py-2 text-sm text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900 ${
                    emailError ? "border-red-400" : "border-zinc-300"
                  }`}
              ...
              <div>
                ...
                >
                  ...
                  <a
                    href="#"
                    className="text-xs font-normal text-zinc-600 hover:underline"
                  >
                    Forgot password?
                  </a>
                </label>
