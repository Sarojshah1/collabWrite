  ...
  return (
    <section className="relative py-20">
      <div aria-hidden className="absolute inset-0 -z-10">
        ...
        <div
          className="absolute -top-28 left-1/2 -translate-x-1/2 w-[900px] h-[900px] rounded-full blur-3xl opacity-40"
          style={{
            background:
      ...
      <div className="mx-auto max-w-6xl px-2 sm:px-6">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm sm:text-base text-zinc-700">
            A single surface where edits, suggestions, and comments flow in real
            time.
          </p>
        </div>
            ...
            >
              <div className="rounded-3xl border border-zinc-200 bg-white shadow-md overflow-hidden">
                ...
                <div className="relative grid grid-cols-[56px,1fr]">
                  ...
                  <div className="relative p-5">
                    <div className="space-y-3 h-60">
                      <motion.div
                        className="h-4 rounded w-11/12 bg-gradient-to-r from-zinc-200 via-zinc-100 to-zinc-200"
                        animate={{
                      ...
                      />
                      <motion.div
                        className="h-4 rounded w-9/12 bg-gradient-to-r from-zinc-200 via-zinc-100 to-zinc-200"
                        animate={{
                          backgroundPosition: ["0% 0%", "100% 0%", "0% 0%"],
                        }}
                        transition={{
                      ...
                      />
                      <motion.div
                        className="h-4 rounded w-8/12 bg-gradient-to-r from-zinc-200 via-zinc-100 to-zinc-200"
                        animate={{
                          backgroundPosition: ["0% 0%", "100% 0%", "0% 0%"],
                        }}
                        transition={{
                      ...
                      />
                      <motion.div
                        className="h-4 rounded w-6/12 bg-gradient-to-r from-zinc-200 via-zinc-100 to-zinc-200"
                        animate={{
                          backgroundPosition: ["0% 0%", "100% 0%", "0% 0%"],
                        }}
                        transition={{
                ...
                <div className="flex items-center gap-2 px-4 py-3 border-t border-zinc-200 text-[11px] text-zinc-600">
                  <span className="inline-flex items-center gap-1 rounded-full border border-zinc-200 px-2 py-1">
                    AI Assist
                  </span>
                  <span className="inline-flex items-center gap-1 rounded-full border border-zinc-200 px-2 py-1">
                    Autosave
          ...
          <div className="space-y-8">
              ...
              <div className="relative h-40">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span
                      className="px-1 py-0.5 rounded-md text-[10px] text-white"
                      style={{ backgroundColor: "var(--color-secondary)" }}
                    >
                      Saroj
                    </span>
            ...
            >
              ...
              <div className="grid grid-cols-3 divide-x divide-zinc-200 text-center text-sm">
                <div className="py-4">
                  <div className="font-[var(--font-display)] text-xl text-zinc-900">
                    2x
                  </div>
