...
export default function DemoConflictPanel() {
  return (
    <section
      ...
      aria-label="Conflict panel live demo"
    >
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm sm:text-base text-zinc-700 max-w-2xl mx-auto">
            Version A vs Version B vs AI merged version — with rationales you
            can skim in seconds.
          </p>
        </div>
          ...
          <div className="grid gap-4 md:grid-cols-[1fr,1fr,1.1fr] p-4 text-xs sm:text-sm text-zinc-800">
            <div className="space-y-2">
              ...
              <p className="rounded-lg border border-zinc-200 bg-zinc-50 p-3 leading-relaxed">
                &quot;Teamwork is important because it helps share tasks fairly
                and finish assignments on time. Everyone should try their best
                so the group grade is high.&quot;
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="rounded-lg border border-zinc-200 bg-zinc-50 p-3 leading-relaxed">
                &quot;Effective collaboration distributes responsibilities,
                reduces last-minute stress, and makes it easier for instructors
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() =>
                    trackEvent("demo_interaction", { action: "accept_merge" })
                  }
              ...
              <p className="rounded-lg border border-zinc-200 bg-zinc-50 p-3 leading-relaxed">
                &quot;Effective teamwork distributes responsibilities fairly,
                reduces last-minute stress, and helps student groups submit
                stronger assignments on time. It also makes it easier for
                instructors to see how each member contributed to the final
                work.&quot;
              </p>
              <div className="rounded-lg border border-dashed border-zinc-300 bg-zinc-50 p-3 text-[11px] text-zinc-700 space-y-1">
                ...
                <ul className="list-disc pl-4 space-y-1">
                  <li>
                    Merged &quot;fairly&quot; and &quot;effective&quot; language
                    from both versions.
                  </li>
              ...
              <div className="flex flex-wrap gap-2 text-[10px] text-zinc-600">
                <button
                  type="button"
                  onClick={() =>
                    trackEvent("demo_interaction", { action: "view_history" })
                  }
                ...
                <button
                  type="button"
                  onClick={() =>
                    trackEvent("demo_interaction", { action: "edit_merge" })
                  }
                  className="inline-flex items-center gap-1 rounded-full border border-zinc-200 px-2 py-1"
                >
                  Edit merge
        ...
        <p className="mt-4 text-center text-xs text-zinc-600">
          Want to try it with your own text? Use assignment mode in the app to
          run a real merge.
        </p>
      </div>
    </section>
