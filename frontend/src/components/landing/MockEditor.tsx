          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-amber-800">
                2 overlapping edits in introduction paragraph.
              </p>
            </div>
          </div>
        ...
        <div className="grid gap-3 px-3 py-2.5 md:grid-cols-3">
          ...
          <div className="space-y-2">
            ...
            <p className="rounded-lg border border-zinc-200 bg-zinc-50 p-2 leading-snug">
              ...
              and finish assignments on time. Everyone should try their best so
              the group grade is high.&quot;
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="rounded-lg border border-zinc-200 bg-zinc-50 p-2 leading-snug">
              ...
              reduces last-minute stress, and makes it easier for instructors to
              evaluate each student&apos;s contribution.&quot;
            </p>
          </div>
          ...
          >
            ...
            <p className="rounded-lg border border-zinc-200 bg-blue-50/60 p-2 leading-snug">
              ...
              reduces last-minute stress, and makes grading each teammate&apos;s
              contribution easier.&quot;
            </p>
            <motion.div
        ...
        <div className="mt-2 border-t border-zinc-100 bg-zinc-50/60 px-3 py-2.5">
          ...
          <div className="relative h-14 rounded-md border border-dashed border-zinc-200 bg-white overflow-hidden">
            <div className="px-3 pt-2 pr-8 text-[11px] leading-snug text-zinc-700">
              Alex and Maya are editing the same paragraph while AI keeps
              everything in sync.
            </div>
            {/* Moving cursors */}
            <motion.div
            ...
            >
              <div className="flex items-center gap-1">
                ...
                />
                <span className="rounded-md bg-amber-500 px-1.5 py-0.5 text-[9px] text-white">
                  Maya
                </span>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-1">
                ...
                />
                <span className="rounded-md bg-blue-600 px-1.5 py-0.5 text-[9px] text-white">
                  Alex
                </span>
              </div>
            </motion.div>
