      ...
      <div className="mx-auto max-w-6xl px-6 flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
        <div className="max-w-xl">
          <p className="text-sm text-zinc-700 italic border-l-2 border-zinc-300 pl-4">
            &quot;We stopped fighting about versions and actually finished on
            time. CollabWrite made it obvious who changed what and when.&quot;
          </p>
        ...
        <div className="space-y-3 text-right md:text-left">
          ...
          <div className="text-xs text-zinc-600">
            <span className="font-semibold text-zinc-900">3.5 hours</span>{" "}
            average time saved per project (placeholder).
          </div>
        </div>
      </div>
    </section>
